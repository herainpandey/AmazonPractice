...
import com.seleniumapi.suite.utils.reports.manager.ExtentManager;
...
public class TestNGListeners extends TestBase implements ITestListener{
        ...
        public void onTestFailure(ITestResult result) {
            ...
            String path = SccreenShotUtils.takeScreenshot(methodName , OrderHelper.getSimpeDateFormat("DD-MM-YY HH_mm_ss"));
            try{
